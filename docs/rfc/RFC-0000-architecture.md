...
- `docs/registers/decisions.md` — 65 entries, of which 2 are OPEN. Append-only; a status may
  change, an entry may not be deleted or renumbered.
- `docs/registers/defects.md` — 124 entries. The roadmap's §5 listed eleven;

...
- `docs/registers/decisions.md` — 53 entries, of which 4 are OPEN. Append-only; a status may
  change, an entry may not be deleted or renumbered.
- `docs/registers/defects.md` — 109 entries. The roadmap's §5 listed eleven;

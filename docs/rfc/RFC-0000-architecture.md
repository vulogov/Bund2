...
- `docs/registers/decisions.md` — 56 entries, of which 3 are OPEN. Append-only; a status may
  change, an entry may not be deleted or renumbered.
- `docs/registers/defects.md` — 116 entries. The roadmap's §5 listed eleven;

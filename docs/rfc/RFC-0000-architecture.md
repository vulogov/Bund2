...
- `docs/registers/decisions.md` — 57 entries, of which 2 are OPEN. Append-only; a status may
  change, an entry may not be deleted or renumbered.
- `docs/registers/defects.md` — 120 entries. The roadmap's §5 listed eleven;

...
- `docs/registers/decisions.md` — 55 entries, of which 3 are OPEN. Append-only; a status may
  change, an entry may not be deleted or renumbered.
- `docs/registers/defects.md` — 113 entries. The roadmap's §5 listed eleven;
